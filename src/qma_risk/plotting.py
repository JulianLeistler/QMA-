...
def plot_pnl_distribution_historical(
    ...
    return apply_standard_layout(fig, "pnl_historical_1y", "pnl_usd", "density_per_usd_e5")
...
def plot_pnl_method_comparison(
    ...
    return apply_standard_layout(fig, "pnl_method_comparison_1y", "pnl_usd", "density_per_usd_e5")
...
def plot_endwert_quantiles(
    ...
    if {"p05", "p95"}.issubset(quantiles.columns):
        fig.add_trace(go.Scatter(x=years, y=quantiles["p95"], mode="lines", name="95 %-Quantil"))
        fig.add_trace(
            go.Scatter(
    ...
    if {"p25", "p75"}.issubset(quantiles.columns):
        fig.add_trace(go.Scatter(x=years, y=quantiles["p75"], mode="lines", name="75 %-Quantil"))
        fig.add_trace(
            go.Scatter(
    ...
    if "p50" in quantiles.columns:
        fig.add_trace(go.Scatter(x=years, y=quantiles["p50"], mode="lines", name="Median"))
    return apply_standard_layout(fig, "endwert_quantiles_5y", "years", "endwert_usd")
...
def plot_var_estimation_uncertainty(
    ...
    return apply_standard_layout(fig, "var_estimation_uncertainty_1y", "var_usd", "density_per_usd_e5")
...
def plot_simulation_paths(
    ...
    return apply_standard_layout(fig, "simulation_paths_5y", "years", "portfolio_value_usd")
